...
def load_industry_features(tickers: list[str]) -> tuple[np.ndarray, list[str]]:
...
def main() -> None:
    ...
    industry_features, industry_feature_names = load_industry_features(tickers)
    ...
    schema = {
        ...
        "exposure_feature_names": ["related_news_exposure"],
    }
