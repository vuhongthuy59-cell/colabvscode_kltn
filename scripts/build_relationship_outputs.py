...
def build_quality_report(
    ...
    rows = [
        ...
        ("company_relationships_rows", len(company_relationships), "Union of parent/subsidiary, same_group, same_industry"),
...
def main() -> None:
    ...
    company_relationships = pd.concat(
        [parent_edges, same_group_edges, same_industry_edges],
        ignore_index=True,
