...
MANUAL_ALIASES: dict[str, tuple[str, list[str]]] = {
    ...
    "VPB": ("VPBank", ["VPB", "VPBank", "Ngan hang Viet Nam Thinht Vuong"]),
    # === Real Estate ===
    "AGG": ("An Gia", ["AGG", "An Gia", "Bat dong san An Gia"]),
    "BCM": ("Becamex IDC", ["BCM", "Becamex", "Becamex IDC"]),
    "CRE": ("CRE", ["CRE", "Bat dong san The Tin"]),
    ...
    "NTL": ("Phat Dat", ["NTL", "Phat Dat", "Bat dong san Phat Dat"]),
    "PDR": ("Phat Dat Realty", ["PDR", "Phat Dat Realty"]),
    ...
    "AAA": ("AAA", ["AAA", "Bao bi Nhu Y"]),
    "APH": ("APH", ["APH", "Nhom Dong A"]),
